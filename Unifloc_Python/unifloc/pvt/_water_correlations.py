...
class WaterCorrelations:
    ...
    def __water_compressibility_kriel(t, p, salinity, **kwargs):
        ...
        water_compr = 0.1 * 145.04 / (7.033 * p + 0.5415 * salinity - 537 * t + 403300)
        return water_compr
